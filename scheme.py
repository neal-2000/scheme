...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        formal, vals, bindings = Pair(bindings.first.first, formal), Pair(scheme_eval(bindings.first.second.first, env), vals), bindings.second
    childframe = env.make_child_frame(formal, vals)
    return childframe
    # END PROBLEM 15
